...
export const SATELLITE_CATALOG = [
  {
    ...
    color: '#00ff9d',
    groundStation: { name: 'Trạm mặt đất Quế Dương (Hoài Đức, HN)', lat: 21.0660, lng: 105.6960 },
  ...
  },
  {
    ...
    color: '#00f3ff',
    groundStation: { name: 'Trạm mặt đất Nam Định', lat: 20.4200, lng: 106.1683 },
...

  {
    ...
    altitudeKm: 680,
    globeAlt: 0.165, // Visual Staggering: 680 km SSO
    inclination: 97.90,
    periodMin: 98.3,
  ...
  },
  {
    ...
    altitudeKm: 420,
    globeAlt: 0.085, // Visual Staggering: 420 km LEO Habitat
    inclination: 51.63,
    periodMin: 92.9,
  ...
  },
  {
    ...
    altitudeKm: 385,
    globeAlt: 0.065, // Visual Staggering: 385 km LEO Module
    inclination: 41.47,
    periodMin: 92.3,
  ...
  },
  {
    ...
    altitudeKm: 525,
    globeAlt: 0.110, // Visual Staggering: 525 km Telescope
    inclination: 28.47,
    periodMin: 95.3,
  ...
  },
  {
    ...
    altitudeKm: 550,
    globeAlt: 0.135, // Visual Staggering: 550 km Mega-Constellation
    inclination: 53.15,
    periodMin: 92.2,
    velocity: '27,324 km/h (7.59 km/s)',
  ...
  },
  {
    ...
    altitudeKm: 20200,
    globeAlt: 0.260, // Visual Staggering: 20,200 km MEO Navstar
    inclination: 56.53,
    periodMin: 718.0,
