...
class LightweightVideoPipeline:
    ...
    def _compose_agent_context(
        ...
        context = (
            ...
            f"   - 19h00 tối ngày 12/9 (đêm hội chính thức) và bay thử/tổng duyệt vào đêm 11/9.\n"
            f"   - CẢNH BÁO QUAN TRỌNG: Lời thoại nói nhanh '19h ngày 12' nên STT âm học có thể bị méo thành '19h22'. TUYỆT ĐỐI KHÔNG đề cập '19h22' trong câu trả lời. Giờ chuẩn là 19h00 ngày 12/09.\n"
            ...
            f"   • ⏰ Thời gian: 19h00 ngày 12/09 (đêm chính thức) & bay thử nghiệm đêm 11/09 (tuyệt đối không đưa số liệu âm học méo 19h22 vào).\n"
            ...
            f"4. Đảm bảo câu trả lời trọn vẹn, không bị cụt lửng, giữ văn phong thông minh, ấm áp và tôn trọng gửi anh Mạnh."
        )
        return context
