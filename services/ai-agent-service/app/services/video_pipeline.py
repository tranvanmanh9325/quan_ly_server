...
class LightweightVideoPipeline:
    ...
    def _compose_agent_context(
        ...
        context = (
            ...
            f"📌 YÊU CẦU TRẢ LỜI: Trình bày bài tóm tắt và phân tích sắc nét, mạch lạc, có cấu trúc (BLUF, Sự kiện, Thời gian, Địa điểm, Hoạt động nổi bật, Đơn vị tổ chức & Giá vé), giọng điệu ân cần, thông minh của Tiểu Bảo Bảo."
        )
        return context
